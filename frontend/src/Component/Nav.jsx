  ...
  return (
    <div className='fixed top-0 bg-[white] z-[20]'>
        <div className='w-[100vw] min h-[80px] border-b-[1px] border-[#dcdcdc] px-[20px] flex items-center justify-between md:px-[40px]' >
            <div>
                <img src={logo} alt="" className='w-[70px] h-[50px] rounded-[50px] border-[2px] border-[red]' />
            </div>
            ...
            <span className='test-[18px] cursor-pointer rounded-[50px] hover:bg-[#ded9d9] px-[8px] py-[5px] hidden md:block' onClick={()=>navigate("/listingpage1")}>List Your Home</span>
                ...
                <div className='max-w-[700px] w-[100vw] h-[300px] overflow-hidden flex flex-col bg-[#fefdfd] p-[20px] rounded-lg border-[1px] border-[#a2a1a1] cursor-pointer'>
                    {
                        searchData.map((search)=>(
                            <div className='border-b border-[black] p-[10px]' onClick={()=>handleViewCard(search._id)}>
