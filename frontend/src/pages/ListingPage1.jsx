...
function ListingPage1() {
  ...
  return (
    <div className='w-[100%] h-[100vh] bg-white flex items-center justify-center relative overflow-auto'>
         ...
         <form action="" className='max-w-[900px] w-[90%] h-[500px] flex items-center justify-start flex-col md:items-start gap-[10px] overflow-auto mt-[50px]' 
         onSubmit={(e)=>{e.preventDefault()
         navigate("/listingpage2")}}>

            <div className='w-[40px] h-[40px] bg-[red] cursor-pointer absolute top-[5%] left-[20px] rounded-[50%] flex items-center justify-center' onClick={()=>navigate("/")}><FaArrowLeftLong className='w-[25px] h-[25px] text-[white]' /></div>
         ...
         <button className='px-[50px] py-[10px] bg-[red] text-[white] text-[18px] rounded-lg md:px-[100px] mt-[20px]'>Next</button>
