...
function ViewCard() {
  ...
  return (
    <div className='w-[100%] h-[100vh] bg-[white] flex items-center justify-center gap-[10px] flex-col overflow-auto relative'>
            <div className='w-[40px] h-[40px] cursor-pointer absolute top-[1%] md:top-[5%] left-[20px] rounded-[50%] flex items-center justify-center bg-[red]' onClick={()=>navigate("/")}>
            ...
            <div className='w-[80%] flex items-start justify-start text-[18px] md:text-[25px]'>
                ...
                <div className='w-[95%] h-[50px] flex items-center justify-center px-[90px] md:justify-start'>
                ...
                {updatePopUp && <div className='w-[100%] h-[100%] flex items-center justify-center bg-[#000000c6] absolute top-[0px] z-[100] backdrop-blur-sm'>
                    <RxCross2 className='w-[30px] h-[30px] cursor-pointer absolute top-[1%] md:top-[5%] left-[20px] rounded-[50%] flex items-center justify-center bg-[red]' onClick={()=>setUpdatePopUp(false)}/>
                       <form action="" className='max-w-[900px] w-[90%] h-[500px] flex items-center justify-start flex-col gap-[10px] overflow-auto mt-[50px] text-[white] bg-[#272727] p-[20px] rounded-lg' 
                                onSubmit={(e)=>{e.preventDefault()
                                navigate("/listingpage2")}}>
                       
                                    <div className='w-[200px] h-[50px] bg-[#f14242] text-[white] flex items-center justify-center rounded-[30px] absolute top-[5%] right-[10px] shadow-xl'>
                                       Update Your Details
                                    </div>
                       
                                    <div className='w-[90%] flex items-start justify-start flex-col gap-[10px]'>
                                    <label htmlFor="title" className='text-[20px]'>Title</label>
                                    <input type="text" id='title' className='w-[90%] h-[40px] border-[2px] border-[#555656] rounded-lg text-[18px] px-[20px] text-[black]' required onChange={(e)=>setTitle(e.target.value)} value={title} placeholder='_bhk house or best title'/>
                                </div>
                                ...
                                <div className='w-[90%] flex items-start justify-start flex-col gap-[10px]'>
                                    ...
                                    <input type="number" id='rent' className='w-[90%] h-[40px] border-[2px] border-[#555656] rounded-lg text-[18px] px-[20px] text-[black]' required onChange={(e)=>setRent(e.target.value)} value={rent} placeholder='Rs.____/day'/>
                                </div>
                       
                                <div className='w-[90%] flex items-start justify-start flex-col gap-[10px]'>
                                    <label htmlFor="city" className='text-[20px]'>City</label>
                                    <input type="text" id='city' className='w-[90%] h-[40px] border-[2px] border-[#555656] rounded-lg text-[18px] px-[20px] text-[black]' required onChange={(e)=>setCity(e.target.value)} value={city} placeholder='city,country'/>
                                </div>
                                ...
                                <button className='px-[10px] py-[10px] bg-[red] text-[white] text-[15px] rounded-lg md:px-[100px] md:text-[18px] text-nowrap' onClick={handleUpdateListing} disabled={updating}>{updating?"Updating...":"Update Listing"}</button>
                                <button className='px-[10px] py-[10px] bg-[red] text-[white] text-[15px] rounded-lg md:px-[100px] md:text-[18px] text-nowrap' onClick={handleDeleteListing} disabled={deleting}>{deleting?"Deleting...":"Delete Listing"}</button>
                                </div>
                                </form> 
                </div>}
               {bookingPopUp && <div className='w-[100%] min-h-[100%] flex items-center justify-center flex-col gap-[30px] bg-[#ffffffa9] absolute top-[0px] z-[100] backdrop-blur-sm md:flex-row md:gap-[100px]'>
                <RxCross2 className='w-[30px] h-[30px] cursor-pointer absolute top-[1%] md:top-[5%] left-[20px] rounded-[50%] flex items-center justify-center bg-[red] text-[white]' onClick={()=>setBookingPopUp(false)}/>
                
                    <form action="" className='max-w-[450px] w-[90%] h-[450px] overflow-auto bg-[#f7fbfcfe] p-[20px] rounded-lg flex items-center justify-start flex-col gap-[10px] border-[1px] border-[#dedddd]' onSubmit={(e)=>{e.preventDefault()}}>
                        <h1 className='w-[100%] py-[10px] flex items-center justify-center border-b-[1px] border-[black] text-[25px]'>Confirm & Book</h1>
                        <div className='w-[100%] h-[70%] mt-[10px] rounded-lg p-[10px]'>
                            <h3 className='text-[19px] font-semibold'>Your Trip -</h3>
                            <div className='w-[90%] flex items-center justify-start md:items-start md:justify-center flex-col md:flex-row gap-[25px] mt-[20px]'>
                                <label htmlFor="checkIn" className='text-[18px] md:text-[20px]'>CheckIn</label>
                                <input type="date" min={minDate} id='checkIn' className='w-[200px] h-[40px] border-[2px] border-[#555656] rounded-lg text-[15px] px-[10px] bg-transparent md:text-[18px]' required onChange={(e)=>setCheckIn(e.target.value)} value={checkIn}/>
                            </div>
                            <div className='w-[90%] flex items-center justify-start md:items-start md:justify-center flex-col md:flex-row gap-[10px] mt-[40px]'>
                                <label htmlFor="checkOut" className='text-[18px] md:text-[20px]'>CheckOut</label>
                                <input type="date" min={minDate} id='checkOut' className='w-[200px] h-[40px] border-[2px] border-[#555656] rounded-lg text-[15px] px-[10px] bg-transparent md:text-[18px]' required onChange={(e)=>setCheckOut(e.target.value)} value={checkOut}/>
                            </div>
                            <div className='w-[100%] flex items-center justify-center'>
                            <button className='px-[80px] py-[10px] bg-[red] text-[white] text-[18px] rounded-lg md:px-[100px] text-nowrap mt-[30px]' onClick={()=>handleBooking(cardDetails._id)} disabled={booking}>{booking?"Booking...":"Book Now"}</button>
                            </div>
                        </div>
                    </form>
                    ...
                    <div className='max-w-[450px] w-[90%] h-[450px] bg-[#f7fbfcfe] p-[20px] rounded-lg flex items-center justify-center flex-col gap-[10px] border-[1px] border-[#e2e1e1]'>
                        <div className='w-[95%] h-[30%] p-[20px] rounded-lg flex items-center justify-center gap-[8px] border-[1px] border-[#dedddd] overflow-hidden'>
                            <div className='w-[70px] h-[90px] rounded-lg flex items-center justify-center flex-shrink-0 md:w-[100px] md:h-[100px]'>
                        ...
                        <div className='w-[95%] h-[60%] bg-[#f7fbfcfe] p-[20px] rounded-lg flex items-start justify-start flex-col gap-[15px] border-[1px] border-[#dedddd]'>
                            ...
                            <p className='w-[100%] flex justify-between items-center px-[20px] border-b-[1px] border-gray-500 pb-[10px]'>
                                <span className='font-semibold'>Website Charge</span>
                                <span>{cardDetails.rent*7/100}</span>
                            </p>
                             <p className='w-[100%] flex justify-between items-center px-[20px]'>
